...
@section('title', 'Registered Tutors')
...
<div class="container-fluid">
        <h3>Registered Tutors</h3>
          ...
          <!-- Add anything from here -->
			      @include('backend.partials._filterTutors')
      <div class="panel panel-default panel-list">
                ...
                <div class="panel-heading compact-pagination ">
                  <div class="row">
                    ...
                    <div class="col-md-3">
                        <!-- some data -->
                        {!! $tutors->appends(array_except(Request::query(), ['page']) )->render() !!}
                    </div>
                  </div>
               </div>
                ...
                <div class="panel-body">
                  @if(!($tutors->isEmpty()))
                    @foreach($tutors as $tutor)
                        @include('backend.partials._tutorCard')
                    @endforeach   
                  @else
                      <p>No records</p>
                  @endif 
