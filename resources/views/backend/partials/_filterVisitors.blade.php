<div id="filter">
    <div class="row">
        <div class="col-md-12">
            {!! Form::open(['route' => 'adminFilterVisitors', 'method' => 'get','class' => 'form-inline']) !!}
                <div class="form-group">
                    <label for="search"><b>Search By:-</b></label>
                    &emsp;
                    {!! Form::select('search', ['0'=>'Select','1' => 'Visitor ID', '2' => 'First Name', '3' => 'Last Name', '4' => 'Contact', '5' => 'Email', '6' => 'Location'],$search) !!}
                    &emsp;
