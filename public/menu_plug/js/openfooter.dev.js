...
(function($){
	...
	var OpenFooterObj = function(e, options){
		...
		if ( ! $(e).find('.of-activebar').length ) {
			$(e).prepend("<div class='of-activebar "+settings.barBg+"'><div class='of-returnbt of-closebt'><img src='images/icons/prev-white.png' alt='return' /></div><div class='of-button of-closebt'></div><div class='of-zoombt'><img src='images/icons/up.png' alt='zoom-in' class='of-in' /><img src='images/icons/down.png' alt='zoom-out' class='of-out' /></div><div class='clearspace'></div></div>");
		}
